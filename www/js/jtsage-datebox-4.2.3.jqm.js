...
(function($) {
    $.widget("jtsage.datebox", {
        ...
        _stdBtn: {
            ...
            clear: function() {
                var w = this, o = this.options;
                return $("<a  href='#' role='button'>" + w.__("clearButton") + "</a>").addClass("ui-btn ui-btn-" + o.themeClearButton + " ui-icon-star ui-btn-icon-left ui-shadow ui-corner-all").on(o.clickEventAlt, function(e) {
                    e.preventDefault();
                    w.d.input.val("");
                    w._t({
                        method: "clear"
            ...
            close: function(txt, trigger) {
                ...
                return $("<a id='btnCalc' style='font-family:Aldrich;' href='#' role='button'>" + txt + "</a>").addClass("ui-btn ui-btn-" + o.themeSetButton + "  ui-icon-deletered ui-btn-icon-left ui-shadow ui-corner-all" + (w.dateOK === true ? "" : " ui-state-disabled")).on(o.clickEventAlt, function(e) {
                    e.preventDefault();
                    if (w.dateOK === true) {
                        if (trigger === false) {
                            w._t({
